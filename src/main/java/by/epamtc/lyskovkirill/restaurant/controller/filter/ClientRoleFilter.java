 ...
 * It is required to prevent access to URLs from users with guest role.
 *
 * @author k1ly
 */
public class ClientRoleFilter implements Filter {
    ...
    public void doFilter(ServletRequest servletRequest, ServletResponse servletResponse, FilterChain filterChain) throws IOException, ServletException {
        ...
        if (userAttr == null || UserRole.GUEST.equals(((UserDTO) session.getAttribute(ControllerConstants.USER)).getRoleName())) {
