 ...
 * for redirecting to Settings page.
 *
 * @author k1ly
 */
public class GoToSettingsPage implements Command {

    @Override
    public CommandResult execute(HttpServletRequest request, HttpServletResponse response) throws CommandException {
        CommandResult commandResult = new CommandResult(Page.SETTINGS_PAGE.getPath());
        ...
        try {
            ...
            throw new CommandException("Error during loading Settings page", e);
        }
