 ...
 * for redirecting to Welcome page.
 *
 * @author k1ly
 */
public class GoToWelcomePage implements Command {
    ...
    public CommandResult execute(HttpServletRequest request, HttpServletResponse response) throws CommandException {
        CommandResult commandResult = new CommandResult(Page.WELCOME_PAGE.getPath());
        ...
        try {
            ...
            throw new CommandException("Error during loading Welcome page", e);
        }
